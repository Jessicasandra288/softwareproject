...
<head>
	...
	<title>Source Code SPK Metode PSI</title>
...
<body>
					...
					<?php if ($_SESSION['level'] == 'admin') : ?>
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								...
								<li><a href="?m=subkriteria"><span class="glyphicon glyphicon-star"></span> Nilai Subkriteria</a></li>
							</ul>
						</li>
						<li class="dropdown">
	...
	<footer class="footer bg-primary">
		<div class="container">
			<p>Copyright &copy; <?= date('Y') ?> Jessicasandra <em class="pull-right">Updated 11 Januari 2023</em></p>
		</div>
	</footer>
